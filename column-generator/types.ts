...
/** Pose to place generated column geometry in world space. */
export interface ColumnDomainPose {
  position: Position;
  rotation: Direction;
}

/** Domain material contract (engine-agnostic). */
export interface ColumnDomainMaterial {
  color?: number | string;
  opacity?: number;
  roughness?: number;
  metalness?: number;
...
/** One generated mesh in domain format. */
export interface ColumnDomainMesh {
  positions: Float32Array;
  indices: Uint32Array;
  uvs?: Float32Array;
  material: ColumnDomainMaterial;
}

/** Engine-agnostic geometry payload generated by column domain logic. */
export interface ColumnDomainGeometry {
  meshes: ColumnDomainMesh[];
}

/** Complete domain output used by integration layers. */
export interface ColumnDomainBuildResult {
  geometry: ColumnDomainGeometry;
  pose: ColumnDomainPose;
  userData: {
    objectType: string;
    column: ColumnParams;
    task: TaskParams;
...
/** userData shape returned by createInstance */
...
/** Solid column instance: object with userData */
