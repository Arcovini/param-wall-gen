/**
 * ColumnMaterialManager - Material creation for columns
 *
...
import type { ColumnMaterialConfig } from '../types';
...
export function createColumnMaterial(config: ColumnMaterialConfig = {}): THREE.MeshStandardMaterial {
