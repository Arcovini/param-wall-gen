/**
 * Three.js adapter for Solid Column
 *
...
/**
 * updateInstance — Apply style update to the column group.
 * Applies: opacity, visibleHeight (clip plane), highlightColor, outlineColor, outlineWidth.
 */
...
/**
 * dispose — Release geometry, materials, and textures used by the column group.
 */
